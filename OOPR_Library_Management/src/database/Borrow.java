...
public class Borrow extends MySQLConnection{
	...
	/*public boolean borrowBook() {
        ...
        // Check the number of active reservations
        ...
        System.out.print("Reservation count: " + reservationCount + "Available Quantity: " + availableQuantity);

        // Allow borrowing if user has a reservation or if reservations are less than available quantity
	...
	public boolean borrowBook() {
	    ...
	    // Allow borrowing only if user has a reservation or if reservations are less than available quantity
	    if (!userHasReservation && reservationCount >= availableQuantity) {
	        System.out.println("Sorry, the book is currently reserved by others.");
	        return false;
	    }
